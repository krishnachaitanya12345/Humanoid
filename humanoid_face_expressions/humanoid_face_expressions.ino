...
LedControl lc = LedControl(D0,D1,D2,D3); //Pin 13 = DIN, Pin 12 = CLK, Pin 11 = CS. 5 = number of displays(D0,D1,D2,D3)(13,12,11,5)
...
// spooky eye
byte neutral_eye_open[8] = {B00000000,
                       B00011000,
                       B00111100,
                       B01111110,
                       B01111110,
...
void loop()
{
  ...
  if (Serial.available())  //verifies if there is serial data available
  {
    ...
    if(cmd == ':') {
      ...
      {
          display_eyes(neutral_eye_open, neutral_eye_open);
          delay(2000);
